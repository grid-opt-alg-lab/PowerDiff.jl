...
function calc_kkt_jacobian_susceptance(prob::DCOPFProblem, sol::DCOPFSolution)
    ...
    for e in 1:m
        ...
        # d(WA)/db_e * theta: row e is -sw_e * A[e,:] * theta = -sw_e * Atheta_e
        # So dK_flow_def/db_e: row e is sw_e * Atheta_e (note the sign flip)
